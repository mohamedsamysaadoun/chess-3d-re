...
ulong ChessEngine_ctor(undefined1 param_1 [16])
...
code_r0x00ee3e34:
  in_x9[1] = uVar11;
  *in_x9 = uVar7;
  *(ulong **)(unaff_x27 + 0xd8) = in_x10;
  do {
    pbVar26 = (byte *)unaff_x19[2];
    pbVar8 = (byte *)unaff_x19[3];
    if ((pbVar8 <= pbVar26) || (*pbVar26 != 0x2b)) {
      uVar16 = 1;
...
code_r0x00ee3f54:
    ...
    } while (pbVar27 < pbVar8);
    if ((pbVar27 < pbVar8) && (*pbVar27 == 0x60)) {
...
code_r0x00ee3f80:
    ...
    *pbVar8 = 0;
    in_x9 = *(ulong **)(unaff_x27 + 0xd8);
    if (in_x9 < *(ulong **)(unaff_x27 + 0xe0)) break;
    unaff_x21 = (long *)(unaff_x27 + 0xd0);
    lVar10 = ((long)in_x9 - *unaff_x21 >> 3) * unaff_x23;
    uVar7 = lVar10 + 1;
  ...
  in_x10 = in_x9 + 3;
  in_x9[2] = (ulong)in_stack_00000010;
  uVar7 = in_stack_00000000;
  uVar11 = in_stack_00000008;
  goto code_r0x00ee3e34;
  while( true ) {
    pcVar13 = pcVar13 + 1;
    ...
    if ((pcVar14 <= pcVar13 + lVar22) || (pcVar13[lVar22] != ']')) {
      ...
      if ((pcVar14 <= pcVar13 + lVar22) || (pcVar13[lVar22] != ',')) {
        ...
        if ((pcVar14 <= pcVar13 + lVar22) || (pcVar13[lVar22] != '*')) {
          ...
          if (pcVar18 < pcVar14) {
            do {
              if ((*pcVar18 != ' ') && (*pcVar18 != '\t')) goto code_r0x00ee4130;
              pcVar18 = pcVar18 + 1;
              uVar7 = 0;
              plVar9[2] = (long)pcVar18;
            ...
            if (pcVar18 < pcVar14) {
              ...
              while( true ) {
                ...
                if (lVar22 == *(long *)(lVar25 + 200)) {
                  plVar2 = (long *)(lVar25 + 0xb8);
                  lVar22 = lVar22 - *plVar2 >> 3;
                  uVar11 = lVar22 * 0x34f72c234f72c235;
                  uVar7 = uVar11 + 1;
                  if (0x11a7b9611a7b961 < uVar7) {
                    uVar7 = func_0x0210a3f0(plVar2);
                  ...
                  func_0x00ee8728(plVar2,auStack_178);
